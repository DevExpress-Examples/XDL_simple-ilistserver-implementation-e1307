...
namespace DevExpress.Sample
{
    public class SimpleServerModeDataSource: IListServer
    {
        ...
        CriteriaOperator IListServer.FilterCriteria
        {
            get
            {
                return filter;
        ...
        object IListServer.FindKeyByBeginWith(PropertyDescriptor column, string value)
        {
            throw new Exception("The method or operation is not implemented.");
        }

        object IListServer.FindKeyByValue(PropertyDescriptor column, object value)
        {
        ...
        object[] IListServer.GetUniqueColumnValues(PropertyDescriptor descriptor, int maxCount, bool includeFilteredOut, bool roundDataTime)
        {
            ArrayList uniqueValues = new ArrayList();
