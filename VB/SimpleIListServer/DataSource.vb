...
Namespace DevExpress.Sample
    Public Class SimpleServerModeDataSource
        ...
        Private Function IListServer_GetUniqueColumnValues(ByVal expression As CriteriaOperator, ByVal maxCount As Integer, ByVal includeFilteredOut As Boolean) As Object() Implements IListServer.GetUniqueColumnValues
            Dim uniqueValues As New ArrayList()
