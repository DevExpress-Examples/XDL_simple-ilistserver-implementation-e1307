...
Namespace DevExpress.Sample
	Public Class SimpleServerModeDataSource
		...
		Private Property FilterCriteria() As CriteriaOperator Implements IListServer.FilterCriteria
			Get
				Return filter
			End Get
		...
		Private Function FindIncremental(ByVal column As PropertyDescriptor, ByVal value As String, ByVal startIndex As Integer, ByVal searchUp As Boolean, ByVal ignoreStartRow As Boolean, ByVal allowLoop As Boolean) As Integer Implements IListServer.FindIncremental
			Throw New Exception("The method or operation is not implemented.")
		End Function

		Private Function FindIncrementalByValue(ByVal column As PropertyDescriptor, ByVal value As Object, ByVal startIndex As Integer, ByVal searchUp As Boolean) As Integer Implements IListServer.FindIncrementalByValue
			Throw New Exception("The method or operation is not implemented.")
		End Function
